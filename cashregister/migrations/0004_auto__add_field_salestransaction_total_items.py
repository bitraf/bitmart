...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SalesTransaction.total_items'
        db.add_column(u'cashregister_salestransaction', 'total_items',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SalesTransaction.total_items'
        db.delete_column(u'cashregister_salestransaction', 'total_items')
